...
struct Matrix4 {
    static Matrix4 zero() {
        Matrix4 ret;
        ret.x.x = 0; ret.x.y = 0; ret.x.z = 0; ret.x.w = 0;
        ret.y.x = 0; ret.y.y = 0; ret.y.z = 0; ret.y.w = 0;
        ret.z.x = 0; ret.z.y = 0; ret.z.z = 0; ret.z.w = 0;
        ret.w.x = 0; ret.w.y = 0; ret.w.z = 0; ret.w.w = 0;
        return ret;
    }
    Matrix4()
    {
